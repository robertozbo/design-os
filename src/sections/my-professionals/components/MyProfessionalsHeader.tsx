...
export interface MyProfessionalsHeaderProps {
  onOpenLink?: () => void
}

export function MyProfessionalsHeader({ onOpenLink }: MyProfessionalsHeaderProps) {
  return (
    <div className="relative overflow-hidden">
      ...
      <div
        ...
        className="
          ...
          bg-[radial-gradient(circle_at_center,rgba(139,92,246,0.12)_0%,rgba(139,92,246,0)_60%)]
          dark:bg-[radial-gradient(circle_at_center,rgba(139,92,246,0.12)_0%,rgba(139,92,246,0)_60%)]
          blur-2xl
        "
      />
      ...
      <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div className="nymos-reveal opacity-0" style={{ animationDelay: '0ms' }}>
          ...
          <p className="mt-1.5 text-sm text-slate-500 dark:text-slate-400">
            Sua rede de cuidado · você controla quem vê o quê
          </p>
        </div>
