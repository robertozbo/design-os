...
import type { EntriesView } from '@/../product/sections/metrics/types'

export interface EntriesControlsBarProps {
  query: string
  view: EntriesView
  onQueryChange: (value: string) => void
  onViewChange: (view: EntriesView) => void
}

export function EntriesControlsBar({
  query,
  view,
  onQueryChange,
  onViewChange,
}: EntriesControlsBarProps) {
  return (
