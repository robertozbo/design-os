...
export function EmptyState({
  ...
  const isNoInvites = variant === 'no-invites'
  return (
    <div
      className={`
        flex flex-col items-center justify-center rounded-2xl border px-6 py-14 text-center
        ${isNoInvites
          ? 'border-teal-200/50 bg-gradient-to-br from-teal-50/50 via-emerald-50/30 to-white dark:border-teal-900/40 dark:from-teal-950/20 dark:via-emerald-950/10 dark:to-slate-950/40'
