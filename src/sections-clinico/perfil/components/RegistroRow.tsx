import type { RegistroProfissional } from '@/../product-clinico/sections/perfil/types'
...
const HOJE = new Date('2026-04-29T12:00:00')
    ...
    >
      <div className="flex items-center justify-between gap-2 mb-1">
        <div className="flex items-center gap-1.5 min-w-0">
          ...
          {registro.primario && (
            <span
              title="Registro primário usado por padrão nos relatórios"
