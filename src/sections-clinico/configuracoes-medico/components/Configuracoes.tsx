...
import type {
  ...
  PacoteSessao,
  SlotDisponibilidade,
} from '@/../product-clinico/sections/configuracoes-medico/types'
    ...
    <SectionWrap titulo="Perfil profissional" descricao="Dados que aparecem para os pacientes e no prontuário" icon={User} cor="bg-violet-500/15 text-violet-300">
      ...
      <div className="flex items-start gap-5 mb-5">
        ...
        <div className="flex-1 grid grid-cols-2 gap-3">
          ...
          <FieldEditable label="CRM" valor={data.crp} mono />
      ...
      <div className="space-y-4">
        ...
        <div>
          <FieldLabel label="Áreas de atuação" />
  ...
  return (
    <SectionWrap titulo="Valores e pacotes" descricao="Preços por modalidade e pacotes oferecidos" icon={DollarSign} cor="bg-emerald-500/15 text-emerald-300">
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        <ValorCard label="Consulta presencial" valor={valores.sessaoPadraoBrl} />
        <ValorCard label="Teleconsulta" valor={valores.sessaoOnlineBrl} />
...
const NOTIF_LABELS: Record<keyof NotificacoesPrefs, { label: string; descricao: string }> = {
  pushSessaoIniciar: { label: 'Lembrete de consulta', descricao: 'Push 10min antes de cada consulta começar' },
  pushPacienteAlerta: { label: 'Alertas clínicos', descricao: 'Exame com valor alterado, mensagem clínica urgente, paciente faltou' },
  pushMensagemPaciente: { label: 'Mensagens de paciente', descricao: 'Toda vez que um paciente envia mensagem clínica' },
  emailResumoDiario: { label: 'Resumo diário por email', descricao: 'Email às 7h com consultas e alertas do dia' },
  emailNovoAgendamento: { label: 'Novo agendamento', descricao: 'Email quando paciente agenda nova consulta' },
  smsLembreteSessao: { label: 'SMS pra paciente', descricao: 'Lembrete via SMS 24h antes da consulta (custo adicional)' },
}
