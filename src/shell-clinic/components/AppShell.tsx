...
export type ShellPersona = 'medico' | 'admin' | 'recepcao'
...
const PERSONA_BADGE: Record<ShellPersona, string> = {
  medico: 'Clínica · Médico',
  admin: 'Clínica · Gestão',
  recepcao: 'Clínica · Recepção',
}
...
export function AppShell({
  ...
  // Ações do UserMenu também navegam — fecham o drawer mobile antes.
      ...
      >
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 p-3 shrink-0">
          <UserMenu
            ...
            onProfileClick={closeThen(onProfileClick)}
