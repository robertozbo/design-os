...
export default function ShellPreview() {
  ...
  const cfg = {
    ...
    admin: {
      ...
      active: '/clinic/sections/inicio-gestao',
  ...
  return (
    <>
      <style>{`
        ...
        body, [data-nymos-clinic],
        [data-nymos-clinic] * {
          font-family: 'DM Sans', ui-sans-serif, system-ui, sans-serif;
          -webkit-font-smoothing: antialiased;
        }
      `}</style>
      <div data-nymos-clinic="true" className="min-h-screen bg-slate-100 dark:bg-slate-950">
