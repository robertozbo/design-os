...
const s = (id: string) => `/medical-clinic/sections/${id}`
...
export const PERSONA_DA_SECTION: Record<string, Persona> = {
  ...
  // A lista de pacientes desenhada mostra condições crônicas e equipe de cuidado — é a visão do
  // médico. A recepção também abre Pacientes, mas só os campos administrativos (nome, contato,
  // convênio, financeiro); essa variante não foi desenhada como tela separada.
  pacientes: 'medico',
