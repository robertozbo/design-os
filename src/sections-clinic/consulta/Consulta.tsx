...
import data from '@/../product-clinic/sections/consulta/data.json'
import type {
  AssinaturaInfo,
  ConsultaData,
  EscribaEstado,
...
import acompanhamentoData from '@/../product-clinic/sections/acompanhamento/data.json'
import type {
  AcompanhamentoData,
  Metrica,
} from '@/../product-clinic/sections/acompanhamento/types'
import { AcompanhamentoView } from '../acompanhamento/components'
import prontuarioData from '@/../product-clinic/sections/prontuario/data.json'
import type {
  AcessoAtual,
