...
import data from '@/../product-clinic/sections/configuracoes-clinica/data.json'
import type {
  ConfiguracoesClinicaData,
  Integracao,
} from '@/../product-clinic/sections/configuracoes-clinica/types'
  ...
  return (
    <>
      <ConfiguracoesClinicaView
        ...
        onContratarAddon={(a) => pushToast(`Contratar ${a.nome} · fluxo de billing (mock)`)}
