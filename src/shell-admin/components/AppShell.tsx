...
interface AppShellProps {
  ...
  onLogout?: () => void
  onProfileClick?: () => void
  /** Sub-brand label shown under "Nymos" (defaults to "Plataforma"). */
  subBrand?: string
}
...
export function AppShell({
  ...
  // O drawer fecha no clique que navega (`handleNavigate`), não num efeito sobre
  // `activeHref`: o efeito rodava a cada mudança de rota só para repetir o que o
  // handler já tinha feito.
