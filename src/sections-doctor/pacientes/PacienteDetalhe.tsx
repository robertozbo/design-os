...
import data from '@/../product-doctor/sections/pacientes/data.json'
import type {
  AtendimentoDetalhe,
  PacienteDetalhe as PacienteDetalheType,
} from '@/../product-doctor/sections/pacientes/types'
    ...
    <>
      <PacienteDetalheView
        ...
        onIniciarConsulta={(id) => {
          ...
          navigate(`/doctor/sections/consulta?agendamento=${id}`)
        }}
        ...
        onAbrirExame={(id) =>
          navigate(
            id === 'exm-imagem-novo'
              ? '/doctor/sections/exames?design=ExameImagemDetalhe'
              : '/doctor/sections/exames?design=ExameDetalhe',
          )
        }
      ...
      <AtendimentoDetalheDrawer
        ...
        onIniciarNovaConsulta={() => navigate(`/doctor/sections/consulta`)}
      />
    </>
  )
}
