...
import data from '@/../product-doctor/sections/consulta/data.json'
import consultasData from '@/../product-doctor/sections/consultas/data.json'
import examesData from '@/../product-doctor/sections/exames/data.json'
import type {
  Consulta as ConsultaType,
  SoapBloco,
  SoapTipo,
  TabAtiva,
} from '@/../product-doctor/sections/consulta/types'
import type { ConsultaFinalizadaItem } from '@/../product-doctor/sections/consultas/types'
import type {
  ExameImagemDetalhe,
...
export default function ConsultaPreview() {
  ...
  // Modo read-only: drill-in vindo de /doctor/sections/consultas
  if (finalizadaId) {
    ...
    if (!finalizada) {
      return (
        <div className="mx-auto max-w-2xl p-8 text-center">
          ...
          <button
            onClick={() => navigate('/doctor/sections/consultas')}
  ...
  return (
    ...
    <ConsultaView
      ...
      onConfirmarAcoesPosConsulta={(ids) => {
        ...
        navigate(`/doctor/sections/consultas?recem=${consulta.id}`)
      }}
