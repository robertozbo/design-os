...
import type { ExameImagemDetalhe } from '@/../product-doctor/sections/exames/types'
import { ImagemMedicaMock } from '@/sections-doctor/exames/components/ImagemMedicaMock'
import {
  AnalisarIADrawer,
  UploadImagemSection,
  type ExameUploadForm,
  type UploadFile,
} from '@/sections-doctor/exames/components/UploadImagemSection'
import { ImagemViewerInline } from '@/sections-doctor/exames/components/ImagemViewerInline'
