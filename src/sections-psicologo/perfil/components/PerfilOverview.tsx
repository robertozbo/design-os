import type {
  PapelPsi,
  PerfilProps,
} from '@/../product-psicologo/sections/perfil/types'
import {
  Pencil,
  Mail,
  Phone,
...
const PAPEL_LABEL: Record<PapelPsi, string> = {
  clinico: 'Psicologia Clínica',
  organizacional: 'Psicologia Organizacional',
  juridico: 'Psicologia Jurídica',
  escolar: 'Psicologia Escolar',
  esportivo: 'Psicologia do Esporte',
  outro: 'Outra área',
}
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
                Suas credenciais aparecem em prontuários, evoluções SOAP/DAP e prescrições que você assina.
              </p>
            </div>
            <button
              type="button"
              ...
              className="
                ...
                shadow-[0_4px_14px_-4px_rgba(139,92,246,0.45)]
          ...
          >
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <span className="mt-2 inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-violet-50 dark:bg-violet-950/40 text-violet-700 dark:text-violet-300 text-[10px] font-medium ring-1 ring-violet-200/60 dark:ring-violet-900/60">
        ...
        <div className="mt-3 grid grid-cols-1 lg:grid-cols-3 gap-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <p className="mt-2 text-[10.5px] text-slate-500 dark:text-slate-400">
                  CFP 11/2018 reconhece assinatura eletrônica em telepsicologia.
                </p>
              </div>
              <div>
                <span className="text-[10px] uppercase tracking-[0.12em] text-slate-500 dark:text-slate-400 font-medium">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              />
              <MiniStat
                icon={<Target className="w-3 h-3" strokeWidth={1.75} />}
                label="Planos terapêuticos"
                value={NUM.format(historicoAtuacao.planosTerapeuticos)}
              />
              <MiniStat
            ...
            <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800">
              ...
              <div className="mt-1.5 flex flex-wrap gap-1">
                {historicoAtuacao.abordagensDominantes.map((esp) => (
                  <span
                    key={esp}
                    className="
