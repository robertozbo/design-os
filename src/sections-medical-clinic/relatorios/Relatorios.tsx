...
import data from '@/../product-medical-clinic/sections/relatorios/data.json'
import type { Periodo, RelatoriosData } from '@/../product-medical-clinic/sections/relatorios/types'
