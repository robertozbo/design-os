...
import data from '@/../product-medical-clinic/sections/inicio-gestao/data.json'
import type { GestaoData, Periodo } from '@/../product-medical-clinic/sections/inicio-gestao/types'
