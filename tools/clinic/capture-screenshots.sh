#!/bin/zsh
# Captura os screenshots das telas do clinic (light + dark) e os grava em
# product-clinic/sections/<id>/.
#
...
#
# Uso:  tools/clinic/capture-screenshots.sh                 # todas as telas
...
echo "✓ screenshots em product-clinic/sections/"
