...
for (const sec of ORDEM) {
  const code = readFileSync(`product-plan-clinic/sections/${sec}/types.ts`,'utf8')
...
writeFileSync('product-plan-clinic/data-shapes/overview.ts', out)
...
writeFileSync('product-plan-clinic/data-shapes/divergencias.md', div)
