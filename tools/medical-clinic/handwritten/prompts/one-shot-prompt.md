...
1. **@product-plan-medical-clinic/product-overview.md** — resumo do produto, personas e entidades
2. **@product-plan-medical-clinic/instructions/one-shot-instructions.md** — instruções de todos os
   milestones

Depois, revise:

- **@product-plan-medical-clinic/design-system/** — cores e tipografia
- **@product-plan-medical-clinic/data-shapes/** — contratos de dados da UI (leia
  `divergencias.md`, não só o `overview.ts`)
- **@product-plan-medical-clinic/shell/** — shell da aplicação
- **@product-plan-medical-clinic/sections/** — componentes, tipos, dados de exemplo e specs de teste
