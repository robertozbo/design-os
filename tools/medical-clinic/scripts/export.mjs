// Monta product-plan-medical-clinic/ a partir de product-medical-clinic/ + src/sections-medical-clinic/.
...
const SRC = 'src/sections-medical-clinic'
const PROD = 'product-medical-clinic/sections'
const OUT = 'product-plan-medical-clinic'
...
function reescrever(code, section) {
  return code.replace(
    /@\/\.\.\/product-medical-clinic\/sections\/([^/']+)\/types/g,
