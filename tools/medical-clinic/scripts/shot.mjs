// Captura screenshots das sections do medical-clinic via CDP direto (Playwright MCP indisponível).
import { writeFileSync, mkdirSync } from 'node:fs'

const BASE = 'http://localhost:3000'
const OUT = 'product-medical-clinic/sections'
const WIDTH = 1440
const DSF = 1
...
for (const { section, design, file } of TARGETS) {
  const url = `${BASE}/medical-clinic/sections/${section}?design=${design}`
