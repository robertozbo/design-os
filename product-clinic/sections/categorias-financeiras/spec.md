...
## Overview
Cadastro das **categorias financeiras** da clínica: **tipos de receita** e **tipos de despesa**, estas classificadas por comportamento **fixa/variável**. Vem pré-carregado com um conjunto abrangente que cobre clínica, personal, psicólogo, médico e nutricionista. Rota própria (`/clinic/sections/categorias-financeiras`), no grupo Financeiro. As contas (a receber/pagar) e os relatórios se apoiam nessas categorias.
