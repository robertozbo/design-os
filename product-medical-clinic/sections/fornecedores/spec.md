...
## Overview
Cadastro básico de **fornecedores** da clínica, com **consulta de CNPJ** (auto-preenche razão social, nome fantasia, telefone e cidade), telefone e categoria (tipo de despesa padrão). Rota própria (`/medical-clinic/sections/fornecedores`), grupo Financeiro. Ao lançar uma **conta a pagar**, o fornecedor é selecionado/pesquisado deste cadastro.
