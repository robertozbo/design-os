...
## Overview
Página dedicada às **despesas** da clínica (fornecedores, aluguel, salários, insumos, impostos). Rota própria (`/medical-clinic/sections/contas-pagar`). KPIs no topo, filtros por período/status/busca, tabela com status e ações, modal de nova conta a pagar e modal de confirmar pagamento.
