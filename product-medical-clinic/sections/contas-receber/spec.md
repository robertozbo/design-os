...
## Overview
Página dedicada aos **recebimentos** da clínica (pacientes e convênios). Rota própria (`/medical-clinic/sections/contas-receber`). KPIs no topo, filtros por período/status/busca, tabela com status e ações, modal de nova conta a receber e modal de confirmar pagamento. Alimentada pelo "Gerar financeiro" do agendamento (cada parcela vira uma conta a receber).
